...
def try_get_data_from_result(result: dict) -> Any:
    ...
    if error is not None:
        ...
        if code == "PTCM-E000":
            ...
            raise CustomerSupportServiceException(message)
        elif code == "PTCM-E101":
            raise SupportRequestNotFoundException(message)
        elif code == "PTCM-E102":
            raise SupportRequestValidationException(message)
        elif code == "PTCM-E103":
            raise SupportRequestPermissionException(message)
        elif code == "PTCM-E104":
            raise SupportRequestStatusException(message)
        elif code == "PTCM-E200":
